...
* Pluginy/softwary, které umožňují dynamické načítání nebo vypínání pluginů.
* Mnoho forkovaných variant Paperu nebo Purpuru může být nestabilních.

> Více o server softwaru v tomto návodu [zde](https://mcnavody.eu/cs/herni-servery).
{.is-info}
...
> Více o předgeneraci světa se dozvíš v tomto návodu [zde](https://mcnavody.eu/cs/predgenerace-sveta).
{.is-info}
